...
const registerSchema = z.object({
  ...
  department: z.string().min(2, { message: 'Please select your department' }).optional(),
      ...
      <main className="flex-grow flex items-center justify-center py-12 bg-gray-50">
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Join the CampusSpark community</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-600">
              ...
              <Link to="/login" className="text-campus-primary hover:underline font-medium">
                Sign In
              </Link>
            </p>
          </div>
